                ...
                <div class="position-relative">
                    ...
                    <div>
                        <div>
                            ...
                            <div>
                                <span class="fw-bolder">Phiếu xuất kho: </span>
                                <span>{{ $phieu->phieuxuat }}</span>
                            </div>
                            <div>
                    ...
                    <div class="mt-3">
                        <div class="d-flex justify-content-between">
                            <div class="w-50 text-center">
                                <p class="fw-bolder m-0">Người Giao Hàng</p>
                                <p class="m-0"><i>(Ký tên)</i></p>
                            </div>
                            <div class="w-50 text-center">
                                <p class="fw-bolder m-0">Người Nhận Hàng</p>
                                <p class="m-0"><i>(Ký tên)</i></p>
                                <p class="mb-0" style="margin-top: 80px;">{{ $phieu->nhanvien_nhanhang->ten }}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    @if(!$phieu->trashed())
    $('#btnXoaPhieu').click(() => {
        sToast.confirm('Xác nhận xóa phiếu nhập kho nội bộ?','',
            (confirmed) => {
    ...
    @else
    $('#btnPhucHoi').click(() => {
        sToast.confirm('Xác nhận phục hồi phiếu nhập kho nội bộ?','',
            (confirmed) => {
                if (confirmed.isConfirmed) {
