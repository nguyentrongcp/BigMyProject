            ...
            <div class="position-relative" id="boxPhieuIn">
                <div class="position-relative">
                    ...
                    <div>
                        <div>
                            <div class="d-flex">
                                <span class="fw-bolder" style="min-width: 67px">Mã phiếu</span>
                                <span class="me-1">:</span>
                                <span>{{ $phieu->maphieu }}</span>
                            </div>
                            <div class="d-flex">
                                <span class="fw-bolder" style="min-width: 67px">Ghi chú</span>
                                <span class="me-1">:</span>
...
<script>
    ...
    @if(!$phieu->trashed())
    $('#btnXoaPhieu').click(() => {
        sToast.confirm('Xác nhận xóa phiếu đầu kỳ hàng hóa?','',
            (confirmed) => {
    ...
    @else
    $('#btnPhucHoi').click(() => {
        sToast.confirm('Xác nhận phục hồi phiếu đầu kỳ hàng hóa?','',
            (confirmed) => {
                if (confirmed.isConfirmed) {
